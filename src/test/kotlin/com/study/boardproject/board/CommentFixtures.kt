...
import com.study.boardproject.board.dto.CommentDto
...
fun createCommentRequest(content:String = CONTENT, depth:Int = DEPTH, boardId:Long = BOARD_ID) : CommentDto
 = CommentDto(content, depth, boardId, EMAIL)
